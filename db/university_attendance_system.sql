...
--
ALTER TABLE `devices`
  ADD COLUMN IF NOT EXISTS `department_id` INT(11) DEFAULT NULL AFTER `location`,
  ADD COLUMN IF NOT EXISTS `last_seen` DATETIME DEFAULT NULL AFTER `status`,
  ADD COLUMN IF NOT EXISTS `ip_address` VARCHAR(45) DEFAULT NULL AFTER `last_seen`;
